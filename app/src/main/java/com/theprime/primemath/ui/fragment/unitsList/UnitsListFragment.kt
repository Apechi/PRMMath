...
import com.theprime.primemath.databinding.FragmentExerciseListBinding
import com.theprime.primemath.ui.view.GridSpacingItemDecoration
import com.theprime.primemath.ui.view.NormalRateDialog
...
class UnitsListFragment : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        requireActivity().onBackPressedDispatcher.addCallback(this) {
            findNavController().navigate(
                UnitsListFragmentDirections.actionUnitsListFragmentToChooseModeFragment(
                    args.player,
                    res = -1
                )
            )
    ...
    private fun exerciseClickCallback(exerciseType: ExerciseType) {
        val direction =
            UnitsListFragmentDirections.actionUnitsListFragmentToUnitsGameFragment(
                exerciseType,
                args.player
            )
